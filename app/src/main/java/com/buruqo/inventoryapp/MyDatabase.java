...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    void addItem(String title,String author,int number){
        ...
        if(result==-1)
        {
            Toast.makeText(context,"Ýþlem Baþarýsýz Oldu",Toast.LENGTH_SHORT).show();

        }else{
            Toast.makeText(context,"Baþarýlý Bir Þekilde Eklendi",Toast.LENGTH_SHORT).show();
    ...
    void updateData(String row_id, String title, String author, String number){
        ...
        if(result == -1){
            ...
            Toast.makeText(context, "Güncelleme Baþarýlý", Toast.LENGTH_SHORT).show();
        }
    ...
    void deleteOneRow(String row_id){
        ...
        if(result == -1){
            ...
            Toast.makeText(context,"Silme Baþarýsýz Oldu", Toast.LENGTH_SHORT).show();

        }else{
            Toast.makeText(context,"Baþarýlý Bir Þekilde Silindi", Toast.LENGTH_SHORT).show();
        }
